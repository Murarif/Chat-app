...
import { Avatar, Divider, IconButton, Typography, Button } from "@mui/material";
  ...
  return (
    <Box sx={{ width: 320, height: "100vh" }}>
      <Stack sx={{ height: "100%" }}>
        <Box
          sx={{
            boxShadow: "0px 0px 2px rgba(0, 0, 0, 0.25px)",
            width: "100%",
            backgroundColor:
        ...
        >
          ...
          >
            ...
            <Stack spacing={1} alignItems={"center"}>
              ...
              <Typography variant="overline">Vidio</Typography>
            </Stack>
          </Stack>
          <Divider />
          <Stack spacing={0.5}>
